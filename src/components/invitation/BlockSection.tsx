  ...
  return (
    ...
    >
      ...
      >
        {shapeType !== 'none' ? (
          <div
className={`relative w-full shadow-xl flex flex-col items-center justify-center px-6 ${compactShape ? 'pt-16 pb-22' : 'pt-26 pb-30'} ${shapeType}`}
            style={{
          ...
          >
            ...
            {(frames === 'both' || frames === 'top') && (
              <img
                ...
                alt="Frame Atas"
                className={`w-full ${smallTopFrame ? 'max-w-[170px] -top-6' : 'max-w-[265px] -top-8'} absolute left-1/2 -translate-x-1/2 drop-shadow-md z-20 pointer-events-none select-none transition-all`}
              />
            )}
            ...
            {(frames === 'both' || frames === 'bottom') && (
              <img
                ...
                alt="Frame Bawah"
                className="w-full max-w-[265px] absolute -bottom-8 left-1/2 -translate-x-1/2 drop-shadow-md z-20 pointer-events-none select-none"
              />
            )}
          </div>
        ) : (
